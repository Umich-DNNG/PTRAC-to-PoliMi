...
if __name__ == "__main__":
    ...
    process_ptrac_hdf5_to_polimi_ascii_parallel(
        # ptrac_hdf5_path='timing_and_par_num_ver/Cf-252/ptrac/all_events/shell_detector.p.h5',
        # ptrac_hdf5_path='timing_and_par_num_ver/Cf-252/two_stilbene.p.h5',
        ptrac_hdf5_path='timing_and_par_num_ver/U-235/ptrac/two_stilbene/nearly_crit/sur_col/two_stilbene.p.h5',
        # polimi_ascii_path='timing_and_par_num_ver/Cf-252/ptrac/all_events/polimi_collision_data_parallel.txt',
        # polimi_ascii_path='timing_and_par_num_ver/Cf-252/polimi_collision_data.txt',
